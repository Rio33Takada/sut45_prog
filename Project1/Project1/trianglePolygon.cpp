...
bool trianglePolygon::createVertexBuffer(ID3D12Device& device) {
...
bool trianglePolygon::createIndexBuffer(ID3D12Device& device) {
...
bool trianglePolygon::create(ID3D12Device &device) {
